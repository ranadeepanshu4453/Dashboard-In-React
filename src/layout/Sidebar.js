...
function Sidebar() {
  ...
  return (
    <div
      ...
      } h-screen p-5 rounded-sm shadow-md transition-all duration-300 overflow-y-auto`}
    >
      ...
      >
        ...
        <Link to="/dashboard">
          <label className="cursor-pointer ml-7">Dashboard</label>
        </Link>
      </button>
      ...
      <ul className="space-y-3">
        ...
        >
          <Link to="/managePT" onClick={() => setActiveItem("Manage PT")}>
            <span className="mr-2">📝</span>
        ...
        >
          <Link to="/branches" onClick={() => setActiveItem("Branches")}>
            <span className="mr-2">📊</span>
        ...
        >
          <Link to="" onClick={() => {
            ...
            <span className="mr-2">👤</span>
            {!isCollapsed && <span>Workouts</span>}
          </Link>
        </li>
        {isWorkoutsOpen && (
          <ul className="ml-5 space-y-2">
            ...
            >
              <Link to="/workout-plans" onClick={() => setActiveItem("Plans")}>
                <span className="mr-2">📋</span>
                {!isCollapsed && <span>Plans</span>}
              </Link>
            </li>
            ...
            >
              <Link to="/workout-categories" onClick={() => setActiveItem("Categories")}>
                <span className="mr-2">📂</span>
            ...
            >
              <Link to="/workout-exercises" onClick={() => setActiveItem("Exercises")}>
                <span className="mr-2">🏋️</span>
        ...
        >
          <Link to="" onClick={() => setActiveItem("templates")}>
            <span className="mr-2">📊</span>
